...
Used the existing key-value store instead of a dedicated shares table to avoid needing database migration access, simpler to ship but less queryable and harder to manage at scale.